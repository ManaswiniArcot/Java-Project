...
<a href = "/MyJavaChallenge/searchUser">Search User</a></p>
</div>
<div id="div2">
<form:form action = "/MyJavaChallenge/files" method = "POST">
<br>
...
<a href = "/MyJavaChallenge/status">Click here</a>to check the status</p>
</div>
<div id="div4">
<p><a href="/MyJavaChallenge/">Click here</a> for the login Page</p>
</div>
