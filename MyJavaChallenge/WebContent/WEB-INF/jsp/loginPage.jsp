...
$(function(){
	...
	$("#myForm").submit(function( event ) {
		 ...
		 // alert( "Handler for .submit() called. user: " + user + " , pass : " + pass + ", json : " + jsonStr );
		  ...
		  $.post( "/MyJavaChallenge/login", JSON.stringify($("#myForm").serializeArray()), function( data ) {
			 alert(data);
			  $( "#result" ).html( data );
...
<form:form id= "myForm" action="/MyJavaChallenge/login" method="POST">
<div>
<ul> 
<li> 
...
<p class ="bold">To access the other end points click on below button</p>
 <form:form action="/MyJavaChallenge/welcome">
